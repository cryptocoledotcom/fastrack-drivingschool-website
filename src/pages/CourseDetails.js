...
const OnlineCourseDescription = () => (
  <div className="online-course-description">
    ...
    <p>Enroll today and take the first step towards becoming a responsible and skilled driver on Ohio's roads!</p>
  </div>
);
...
const OnlineAndBehindTheWheelCourseDescription = () => (
  <div className="online-course-description">
    ...
    <h3>Choose the complete package for the easiest, most efficient, and most affordable path to getting your Ohio driver's license.</h3>
  </div>
);
